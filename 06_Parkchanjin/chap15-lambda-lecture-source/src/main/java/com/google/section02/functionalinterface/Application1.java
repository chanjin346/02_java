package com.google.section02.functionalinterface;
 ...
 *  단, 한 줄의 코드가 return 구문이면 return도 생략가능
 *
...
public class Application1 {
  public static void main(String[] args) {
    ...
    *  - Return 값이 없는 accept() 메서드를 가지고 있다.
    *
    *  1. Consumer<T> #accept(T t) :void (반환형) 객체 T를 받아 소비한다.*/
