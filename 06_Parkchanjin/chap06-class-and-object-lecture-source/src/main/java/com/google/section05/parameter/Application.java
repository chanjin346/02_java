package com.google.section05.parameter;
...
public class Application {
  public static void main(String[] args) {
    ...
    /* 메서드 호출 시 전달 가능한 자료형
    *  - 기본 자료형
    *  - 기본 자료형 배열, 클래서 자료형 , 클래스 자료형 배열, 가변 인자
    *  (주소 값 (reference) 저장)
    * */
    ...
    pt.testVariableLengthArrayParameter("정진호", "스타벅스가기", "500만원 쓰기", "마카롱 사서 옆반 주기", "염탐하기","부정안하기");
