package com.google.section02.set;
...
public class Application2 {
  public static void main(String[] args) {
    ...
    *
    *  LinckedHashSet : hashCode를 이용해서 검색 속도를 증가시킨 Set + 순서 유지 O=O
    *  - 사용 조건 : Set에 저장되는 인스턴스는 equals(), hashCode() 오버라이딩이 필수다
    *  */
